...
- Define an SAB for your domain--e.g., BAKING. UBKG will assing this SAB to the relationships that you define in your **edges.tsv** file.
...
- Identify suitable relationships from RO, where applicable. For example, 
