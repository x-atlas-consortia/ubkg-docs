...
We have sought to identify the following for the sources used in UBKG contexts:
1. Citation references. The preferred form of citation is a PubMed ID. 
2. Applicable licensing.

Sources for citation references and licensing include:
1. OBO home page
...
|------------------------------------------------------------|---------------------------------------------------|--------------|------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------|
| UMLS                                                       | Standarizes format of CodeID                      | ontlogy      | DBMI Neptune                             | [PMID:14681409 ](https://pubmed.ncbi.nlm.nih.gov/14681409/)                                                                                                                       |                                                                   | The UBKG steward has a distributor license. A UBKG consumer must have a user [UMLS license](https://www.nlm.nih.gov/databases/umls.html). |
| [UBERON](https://obofoundry.org/ontology/uberon.html)      | Uber Anatomy Ontology                             | ontology     | OBO Foundry                              | [PMID:22293552](https://pubmed.ncbi.nlm.nih.gov/22293552/)                                                                                                                        |                                                                   | [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/)                                                                                 |
